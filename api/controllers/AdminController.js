...
module.exports = {
  ...
  createTeam: asyncHandler(function (req, res) {
    ...
    var new_team = {active: false, official_team_name: req.param('officialName'), owner_email: req.param('ownerEmail'), code: Math.random().toString(36).substring(3, 12), secret: Math.random().toString(36).substring(3, 14), last_content_edit: new Date()};
