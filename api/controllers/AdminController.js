...
module.exports = {
  ...
  createTeam: asyncHandler(function (req, res) {
    ...
    var new_team = { official_name: req.param('official_name'), ownerEmail: req.param('ownerEmail'), code: Math.random().toString(36).substring(3, 12), secret: Math.random().toString(36).substring(3, 14)};
