...
module.exports = {
  ...
  createTeam: asyncHandler(function (req, res) {
    ...
    var new_team = {active: false, opted_in: false, official_team_name: req.param('officialName'), owner_email: req.param('ownerEmail'), code: req.param('code'), secret: Math.random().toString(36).substring(3, 14), sync_id: 1};
