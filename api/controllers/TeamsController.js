...
module.exports = {
  ...
  */
  ...
  pushForm: asyncHandler(function(req, res) {
    ...
    try {
      var query = {code: req.param('code')};
      var teams_ref = await(Teams.update(query, {form: req.param('content'), last_content_edit: new Date().getTime()})); 
  ...
  pushUI: asyncHandler(function(req, res) {
    ...
    try {
      ...
      var d = new Date();
      var n = d.getTime();
      var teams_ref = await(Teams.update(query, {ui: req.param('content'), last_content_edit: new Date().getTime()})); 
