  ...
  init: asyncHandler( function (req, res) {
    ...
    try {
      ...
      await(Teams.update(query, {
        ...
        , form: req.param('form'), ui: req.param('ui'), active: true, tba_event_key: req.param('tbaKey'), syncID: 0
      }));
  ...
  pushCheckouts: asyncHandler(function (req, res) {
    ...
    for(item in classmem) {
      ...
      try {
        ...
        var new_checkout = {id: id2, content: null, status: 0, code: req.param('code'), sync_id: 1};
